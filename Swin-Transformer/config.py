...
_C.TRAIN.BASE_LR = 5e-4 / 8 * 2.828
_C.TRAIN.WARMUP_LR = 5e-7 / 8 * 2.828
_C.TRAIN.MIN_LR = 5e-6 / 8 * 2.828
# Clip gradient norm
...
_C.TRAIN.debias = True

# configs for SLAMB optimizer
_C.TRAIN.SLAMB = CN()
_C.TRAIN.SLAMB.compress_ratio = 0.1
_C.TRAIN.SLAMB.beta3 = 0.999
_C.TRAIN.SLAMB.local_steps = 100
_C.TRAIN.SLAMB.c_max = 1000
_C.TRAIN.SLAMB.c_min = 0.01
_C.TRAIN.SLAMB.grad_size_thr = 9000
